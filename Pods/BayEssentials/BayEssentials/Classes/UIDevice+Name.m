...
+ (BOOL)isJailbroken
{
    ...
    NSString *aptFilePath = @" /private/var/lib/apt/";
    return ([[NSFileManager defaultManager] fileExistsAtPath:cydiaFilePath] ||
            [[NSFileManager defaultManager] fileExistsAtPath:aptFilePath]);
}
